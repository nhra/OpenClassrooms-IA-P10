...
class ReturnDateResolverDialog(CancelAndHelpDialog):
    ...
    async def initial_step(
        ...
        prompt_msg_text = "What is your travel return date?"
        prompt_msg = MessageFactory.text(
            prompt_msg_text, prompt_msg_text, InputHints.expecting_input
        )

        reprompt_msg_text = (f"I'm sorry, the return date is ambiguous. For best results, please enter the date including the month, " 
                             f"day and year, e.g. July 25 2021")
        #reprompt_msg_text = "I'm sorry, for best results, please enter your travel return date including the month, " \
        #                    "day and year. "
